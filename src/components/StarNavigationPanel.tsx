...
export function StarNavigationPanel({
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-20 pointer-events-auto"
        ...
        >
          <div className="frosted-glass-strong rounded-2xl border border-cosmic-particle-trace p-6 max-w-md mx-auto">
            {/* Progress Indicator */}
            ...
            >
              ...
              <div className="relative mb-4 h-16 flex items-center justify-center">
                <motion.div
                  ...
                  style={{ 
                    ...
                    width: currentStar.visual_data.size * 48,
                    height: currentStar.visual_data.size * 48,
                    boxShadow: `0 0 ${currentStar.visual_data.size * 30}px ${currentStar.visual_data.color}60`
                  }}
                  animate={{ 
                    opacity: [
                ...
                >
                  <StarIcon className="w-6 h-6 text-cosmic-observation" />
                </motion.div>
              </div>
              ...
              {/* Star Description */}
              <p className="text-cosmic-light-echo text-sm leading-relaxed mb-3 font-light">
            ...
            <motion.button
              ...
              className="w-full mt-6 bg-gradient-to-r from-cosmic-cherenkov-blue to-cosmic-plasma-glow hover:from-cosmic-plasma-glow hover:to-cosmic-stellar-wind text-cosmic-observation font-light py-3 px-6 rounded-xl transition-all duration-500 flex items-center justify-center gap-3 group cherenkov-glow"
              style={{
            ...
            {/* Instructions */}
            <motion.div
              className="mt-4 text-center text-cosmic-stellar-wind text-xs font-light opacity-70"
              initial={{ opacity: 0 }}
              animate={{ opacity: 0.7 }}
              transition={{ delay: 1 }}
            >
